...
// XBEE MESSAGE INTERRUPT HANDLER

// the uart handle structure is defined elsewhere (in this case in xbee.c)
extern UART_HandleTypeDef xbee_handle;
...
void USART6_IRQHandler(void)
{
  ...
  HAL_UART_IRQHandler(&xbee_handle);
}
